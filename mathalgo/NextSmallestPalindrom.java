...
public class NextSmallestPalindrom {
@Test
    public void test(){
    ...
    // input type 2 and 3
    public void generateNextPalindromeUtil(int num[], int n)
    {
        int mid = n / 2;
    ...
    public void generateNextPalindrome(int num[], int n)
    {
    ...
    public boolean isAll9(int num[], int n) {
        for (int i = 0; i < n; i++)
            if (num[i] != 9)
                return false;
        return true;
